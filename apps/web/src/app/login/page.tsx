...
import { Eye, EyeOff, User, Lock, ArrowRight, Sparkles, AlertCircle } from "lucide-react";
      ...
      <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-6 duration-700">
        ...
        <div className="glass-card rounded-2xl p-8 relative overflow-hidden">
          ...
          <div
            ...
            style={{
              background: `linear-gradient(90deg, oklch(0.75 0.15 195), oklch(0.7 0.2 320))`,
            }}
          />

          {/* Header */}
          <div className="text-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500 fill-mode-both" style={{ animationDelay: "100ms" }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Username Field */}
            <div className="space-y-2 animate-in fade-in slide-in-from-bottom-4 duration-500 fill-mode-both" style={{ animationDelay: "150ms" }}>
            ...
            {/* Password Field */}
            <div className="space-y-2 animate-in fade-in slide-in-from-bottom-4 duration-500 fill-mode-both" style={{ animationDelay: "200ms" }}>
            ...
            {/* Forgot Password */}
            <div className="text-right animate-in fade-in slide-in-from-bottom-4 duration-500 fill-mode-both" style={{ animationDelay: "250ms" }}>
              <Link
                href="/forgot-password"
                className="text-sm text-white/40 hover:text-[oklch(0.75_0.15_195)] transition-colors"
              >
                Forgot password?
              </Link>
            </div>
          ...
          {/* Divider */}
          <div className="flex items-center gap-4 my-8 animate-in fade-in duration-500 fill-mode-both" style={{ animationDelay: "350ms" }}>
          ...
          {/* Social Login */}
          <div className="grid grid-cols-2 gap-3 animate-in fade-in slide-in-from-bottom-4 duration-500 fill-mode-both" style={{ animationDelay: "400ms" }}>
            <Button
              type="button"
              variant="outline"
          ...
          {/* Register Link */}
          <p className="text-center text-sm text-white/40 mt-8 animate-in fade-in duration-500 fill-mode-both" style={{ animationDelay: "450ms" }}>
        ...
        {/* Back to Home */}
        <div className="text-center mt-6 animate-in fade-in duration-500 fill-mode-both" style={{ animationDelay: "500ms" }}>
          <Link
            href="/"
